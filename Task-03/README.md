...
During investigation, the `reverse-mountain` Rust crate had an integration test failure related to the configured assets directory.

The failing test reported:
